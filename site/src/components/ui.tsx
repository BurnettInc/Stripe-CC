...
export const BTN_SECONDARY_NAV =
  "inline-flex items-center justify-center rounded-lg border border-indigo-600 bg-transparent px-4 py-2 text-sm font-medium text-indigo-600 transition-colors hover:bg-indigo-50";
